...
namespace Pomelo.WebglPomelo
{
    public class MessageProtocol
    {
        ...
        private WebglProtobuf.Protobuf protobuf;
        ...
        public MessageProtocol(JsonObject dict, JsonObject serverProtos, JsonObject clientProtos)
        {
            ...
            protobuf = new WebglProtobuf.Protobuf(clientProtos, serverProtos);
        ...
        public byte[] encode(string route, uint id, JsonObject msg)
        {
            ...
            if (id > 0)
            {
                byte[] bytes = WebglProtobuf.Encoder.encodeUInt32(id);
        ...
        public Message decode(byte[] buffer)
        {
            ...
            {
                int length;
                id = (uint)WebglProtobuf.Decoder.decodeUInt32(offset, buffer, out length);
